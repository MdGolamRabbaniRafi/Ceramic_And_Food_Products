...
export class CartController {
  ...
  @Post('add')
  async addToCart(@Body() cartData: any): Promise<{ success: boolean; message: string, cart:CartEntity }> {
  ...
  @Delete('user/:userId')
  async deleteCartByUser(@Param('userId') userId: number): Promise<{ success: boolean }> {
